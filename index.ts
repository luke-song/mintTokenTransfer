...
(async () => {
  ...
  // Get the token account of the fromWallet Solana address
  ...
  // new wallet to receive the newly minted token
  const toWallet = Keypair.generate();

  // Get the token account of the toWallet Solana address
